...
#@onready var upload_button: Button = %"UploadButton" as Button
#@onready var progress: ProgressBar = %"ProgressBar" as ProgressBar
#@onready var success_label: Label = %"SuccessLabel" as Label
